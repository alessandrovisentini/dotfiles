...
do
  ...
  -- Gitignored-aware file/grep ignores
...
do
  ...
  vim.api.nvim_create_autocmd('LspAttach', {
    ...
    callback = function(event)
      ...
      -- Familiar bindings kept alongside the kickstart `gr*` set.
  ...
  local servers = {
    ...
    --
    -- TypeScript/JavaScript LSP — prefer relative imports.
    ts_ls = {
      init_options = {
        preferences = {
...
do
  ...
  require('conform').setup {
    ...
    format_on_save = function(bufnr)
      -- Format on save for everything except languages without a canonical style.
